...
└───── •✧✧✧✧✧✧✧• ──────┘`; // 
          ...
          case 'downloadermenu':
            case 'dlmenu' :
          lkr = `┌────•✧𝘿𝙇 𝘾𝙊𝙈𝙈𝘼𝙉𝘿𝙎✧•────┐
┊ 🇹🇿 ${usedPrefix}𝙋𝙡𝙖𝙮     𝙉𝙖𝙖𝙩...
┊ 🇹🇿 ${usedPrefix}𝙋𝙡𝙖𝙮2    𝙉𝙖𝙖𝙩...
┊ 🇹🇿 ${usedPrefix}𝙄𝙜      𝙐𝙍𝙇
┊ 🇹🇿 ${usedPrefix}𝙁𝙗       𝙐𝙍𝙇
┊ 🇹🇿 ${usedPrefix}𝙄𝙢𝙜      𝙉𝙖𝙢𝙚
┊ 🇹🇿 ${usedPrefix}𝙂𝙙𝙧𝙞𝙫𝙚     𝙐𝙍𝙇
┊ 🇹🇿 ${usedPrefix}𝙂𝙞𝙩𝙘𝙡𝙤𝙣𝙚    𝙐𝙍𝙇
┊ 🇹🇿 ${usedPrefix}𝙞𝙜𝙨𝙩𝙖𝙡𝙠      𝙐𝙨𝙚𝙧𝙣𝙖𝙢𝙚
┊ 🇹🇿 ${usedPrefix}𝙈𝙚𝙙𝙞𝙖𝙛𝙞𝙧𝙚     𝙐𝙍𝙇
┊ 🇹🇿 ${usedPrefix}𝙈𝙛𝙞𝙧𝙚      𝙐𝙍𝙇
┊ 🇹🇿 ${usedPrefix}𝙏𝙞𝙠𝙩𝙤𝙠.     𝙐𝙍𝙇
┊ 🇹🇿 ${usedPrefix}𝙏𝙞𝙠𝙩𝙤𝙠𝙨𝙩𝙖𝙡𝙠     𝙐𝙨𝙚𝙧𝙣𝙖𝙢𝙚
┊ 🇹🇿 ${usedPrefix}𝙏𝙬𝙞𝙩𝙩𝙚𝙧     𝙐𝙍𝙇
┊ 🇹🇿 ${usedPrefix}𝙔𝙩𝙨      𝙉𝙖𝙢𝙚/𝙐𝙍𝙇
┊ 🇹🇿 ${usedPrefix}𝙔𝙩𝙢𝙥4    𝙐𝙍𝙇
┊ 🇹🇿 ${usedPrefix}𝙔𝙩𝙢𝙥3    𝙐𝙍𝙇
┊ 🇹🇿 ${usedPrefix}𝙔𝙩𝙖      𝙐𝙍𝙇
┊ 🇹🇿 ${usedPrefix}𝙎𝙤𝙣𝙜    𝙉𝙖𝙢𝙚
┊ 🇹🇿 ${usedPrefix}𝙑𝙞𝙙𝙚𝙤    𝙐𝙍𝙇
┊ 🇹🇿 ${usedPrefix}𝘼𝙥𝙠     𝙉𝙖𝙢𝙚/𝙐𝙍𝙇
┊ 🇹🇿 ${usedPrefix}𝙋𝙞𝙣𝙩𝙚𝙧𝙚𝙨𝙩    𝙐𝙍𝙇
└───── •✧✧✧✧✧✧✧✧✧• ─────┘`; // 
